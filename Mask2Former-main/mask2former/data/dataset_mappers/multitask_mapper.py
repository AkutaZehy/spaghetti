...
from detectron2.structures import Instances, PolygonMasks, BitMasks
    ...
    def __init__(
        ...
        *,
        ...
        logging.getLogger(__name__).info(
            "[MultitaskDatasetMapper] Full TransformGens used in training: {}".format(str(self.tfm_gens))
        )
