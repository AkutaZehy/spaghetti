    ...
    数据集目录结构：
      root/
         defectt/
           ...
           val2025/         # 验证图片目录
    """
    defect_root = os.path.join(root, "defectt")
    dataset_splits = [
        ("defectt_train2025", "annotations/instances_train2025.json", "train2025"),
        ("defectt_val2025", "annotations/instances_val2025.json", "val2025"),
    ]
    thing_classes = ["linear", "block", "point"]
