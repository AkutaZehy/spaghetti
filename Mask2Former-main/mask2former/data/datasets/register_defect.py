...
def register_defect(root):
    ...
    dataset_splits = [
        ("defect_train2025", "annotations/instances_train2025.json", "train2025"),
        ("defect_val2025", "annotations/instances_val2025.json", "val2025"),
    ]
    thing_classes = ["crack", "dent", "erosion", "scratch"]
    ...
    for dname, ann_file, img_dir in dataset_splits:
        ...
        MetadataCatalog.get(dname).set(
            ...
            type_classes=["linear", "block", "point"],
            position_classes=["surface", "edge"],
            evaluator_type="coco"
        )
        print(f"Registered dataset: {dname}")

_root = os.getenv("DETECTRON2_DATASETS", "datasets")
register_defect(_root)